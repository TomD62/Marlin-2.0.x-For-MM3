...
#define HOTEND_OFFSET_Y { 0.0, 1.50 }  // (mm) relative Y-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki_LIST {   1.47,   1.47 }
    #define DEFAULT_Kd_LIST {  60.12,  60.12 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 800, 102 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 15, 20 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, 30, 0 }
...
// Turn this off for now, will have to add a M242 code to gcode.h 
// move the MTWLED and bits of Marlin_mian.cpp M242 code to it's own M424.cpp in gcode/control
// OhmEye did this coding for MTW, maybe he ported to Marlin 2.x ?
// https://github.com/OhmEye/OhMarlin
#ifdef MTWLED
